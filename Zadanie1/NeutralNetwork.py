...
class NeutralNetwork:
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate=0.1, bias_mult=0,
    ...
    def train(self, input_list, target_list):
        ...
        self.wih += self.lr * numpy.dot((hidden_errors * self.dactivation_function_output(hidden_outputs)),
                                        numpy.transpose(inputs))
        self.wih+=self.wih*self.momentum

        self.bih += self.lr * hidden_errors * self.dactivation_function_output(hidden_outputs)
